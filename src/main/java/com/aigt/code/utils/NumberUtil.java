...
public class NumberUtil extends org.springframework.util.NumberUtils {
    ...
    public static String padNum(int length, int number){
    	...
    	if(length >= numberLength){
    		...
    		// member>length ,从后面截取length的长度
    		return StringUtils.substring(String.valueOf(number), -length);
		}
    	return buf.toString();
    }
	 ...
	 * @since 2019-03-06 10:57
	 */
	public static List<Integer> convert2List(int[] array) {
		...
		try {
			...
			LOGGER.error("int数组转integer集合异常", e);
